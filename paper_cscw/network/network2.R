...
en.cent.measures <- load.visualize.network("en_network_matrix.txt", 
                                           "en_category_count.txt",
                                           vcolor="darksalmon")
print(en.cent.measures)

es.cent.measures <- load.visualize.network("es_network_matrix.txt",
                                           "es_category_count.txt", 
                                           vcolor="red")
print(es.cent.measures)

it.cent.measures <- load.visualize.network("it_network_matrix.txt", 
                                           "it_category_count.txt",
                                           vcolor="green")
print(it.cent.measures)

pt.cent.measures <- load.visualize.network("pt_network_matrix.txt",
                                           "pt_category_count.txt", 
                                           vcolor="blue")
print(pt.cent.measures)
